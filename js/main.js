...
$(document).ready(function(){
   ...
   $(window).scroll(function() {
    ...
    // ROLLBAR
	TBUI.bd.append('<div class="rollbar">'+ (is_page('comment-open') ? '<div class="rollbar-item" etap="to_comments"><i class="fa icon pinglun"></i></div>' : '') +'<div class="rollbar-item" etap="to_top"><i class="fa icon top"></i></div></div>')
