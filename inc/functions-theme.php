...
function _load_scripts()
{
    if (!is_admin()) {
        ...
        wp_enqueue_style('font-awesome', get_stylesheet_directory_uri() . '/css/font-awesome.min.css', array(), _the_theme_version(), 'all');
 ...
 * get post mostviews
 */
function _posts_mostviews($mode = 'post', $limit = 8, $days = 15, $display = true)
{
    global $wpdb, $post;
