...
CSF::createSection( $prefix, array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'library'      => 'image',
      'placeholder'  => 'http://',
      'default'  => 'http://data.ulmt.com/Image/wp/login-bg.jpg',
    ),
        // array(
        //   'id'        => '_src',
        //   'type'      => 'media',
...
CSF::createSection( $prefix, array(
  ...
  'fields'      => array(
    ...
    'library'      => 'image',
    'placeholder'  => 'http://',
    'default'  => 'http://data.ulmt.com/Image/wp/bg.jpg',
  ),
    array(
      'id'    => 'search_no_page',
      'type'  => 'switcher',
    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'default'      => array('url' =>'http://data.ulmt.com/Image/wp/wordpress-cat.jpg'),
        ),
      ),
    ),
...
CSF::createSection( $prefix, array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'add_title' => '上传',
      'desc'      => '',
      'default'   => array('url' =>'http://data.ulmt.com/Image/wp/wechat.png'),
    ...
    array(
      ...
      'add_title' => '上传',
      'desc'      => '',
      'default'   => array('url' =>'http://data.ulmt.com/Image/wp/alipay.png'),
      'dependency'  => array( 'post_rewards_s', '==', 'true' ),
    ),
    array(
      ...
      'add_title' => '上传',
      'desc'      => '',
      'default'   => array('url' =>'http://data.ulmt.com/Image/wp/wechatpay.png'),
      'dependency'  => array( 'post_rewards_s', '==', 'true' ),
    ),
    array(
      'id'    => 'post_like_s',
...
CSF::createSection( $prefix, array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'default'      => array('url' =>'http://data.ulmt.com/Image/wp/login-bg.jpg'),
    ),
    array(
      'id'    => 'is_write',
      'type'  => 'switcher',
