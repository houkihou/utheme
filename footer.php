...
<footer class="footer">
	...
	<div class="footer-copyright">
	    <p align="center" style='text-align:center'> Copyright &copy;<?php echo date('Y'); ?>  <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a> All Rights Reserved.</p>
